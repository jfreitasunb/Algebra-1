...
\begin{document}
    ...
    \begin{frame}
        \begin{corolario}
            Se $f : A \to B$ \pause e $g : B \to C$ \pause s{\~a}o fun\c{c}\~oes bijetoras, \pause ent{\~a}o $g\circ f : A \to C$ \pause {\'e} bijetora.
        \end{corolario}
    \end{frame}
    ...
    \begin{frame}
        \begin{proposicao}
            Sejam $f : A \to B$ \pause e $g : B \to A$ \pause s{\~a}o fun{\c c}{\~o}es. \pause Se $g\circ f = i_{A}$ \pause e $f\circ g = i_{B}$, \pause ent{\~a}o \pause $f$ e $g$ s{\~a}o bijetoras \pause e $g=f^{-1}$.
        \end{proposicao}
    \end{frame}
