...
\noindent {\bf{SISTEMA DE AVALIA\c{C}\~{A}O:}} Serão realizadas três provas individuais, em horários normais de aulas da turma \textbf{D}. A cada prova será atribuída uma nota de zero a dez. Denotando por $P_i$, com $1 \le i \le 3$, a nota da $i$-ésima prova, a nota final ($NF$) de cada estudante ser\'a dada por:
\[
