...
\vspace{0.5cm}
\noindent\textit{Testes em sala}: estes testes ser\~ao marcados com pelo menos uma semana de anteced\^encia pelo professor e ser\~ao feitos nos 40 (quarenta) minutos finais da aula. O teste consistirá de \textbf{2 (dois)} exercícios, sendo que \textbf{somente 1 (um) será corrigido} para atribuição da nota. Uma nota entre 0 e 10 ser\'a atribu{\'\i}da ao grupo.
