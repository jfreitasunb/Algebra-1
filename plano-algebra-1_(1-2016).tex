...
\noindent {\bf{SISTEMA DE AVALIA\c{C}\~{A}O:}} Serão realizadas três provas individuais, em horários normais de aulas da turma \textbf{D}. A cada prova será atribuída uma nota, $P_i$ $1 \le i \le 3$, de zero a dez. As três provas terão o mesmo peso e a nota final ($NF$) de cada estudante \'e dada por:
\[
