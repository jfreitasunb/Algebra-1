...
{\Large\bf {\'A}lgebra 1 - Turma B} \\ \vspace{9pt} {\large\bf
  $5^{\underline{a}}$ Lista de Exerc{\'\i}cios -- 2$^{o}$/2015}\\ \vspace{9pt} Prof. Jos{\'e} Ant{\^o}nio O. Freitas
\end{center}
\hrule
...
\questao Considere as operações $\star$ e $\odot$ em $\q$ definidas por
\begin{align*}
	x \star y = x + y - 3\\
	x \odot y = x + y - \dfrac{xy}{3}.
\end{align*}
Mostre que $(\q, \star, \odot)$ é um anel comutativo e com unidade.
...
\begin{enumerate}[label={\alph*})]
	...
	\item O conjunto $\q$ com as operações $x \oplus y = x + y - 1$ e $x \odot y = x + y - xy$.
	...
	\end{align*}
\end{enumerate}
Quais destes anéis são comutativos. Quais têm unidade.
