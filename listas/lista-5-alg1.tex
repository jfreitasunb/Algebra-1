...
\questao\label{verificar_se_e_homomorfismo} Verificar em cada caso de $f$ é um homomorfismo de grupos.
\begin{enumerate}[label=({\alph*})]
...
\questao Determinar os homomorfismos injetores e os sobrejetores do exercício anterior.

\vesp

\questao Determine o núcleo em cada homomorfismo do exercício \ref{verificar_se_e_homomorfismo}.

\vesp

\questao Seja $f: \z \times \z \to \z \times \z$ definida por $f(x, y) = (x - y, 0)$. Provar que $f$ é um homomorfimo do grupo aditivo $\z \times \z$ em si próprio. Obter $\ker(f)$.
