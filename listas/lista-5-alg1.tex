...
\begin{enumerate}[label=({\alph*})]
	...
	\[
		K = \left\{ A = \begin{pmatrix}
			a & b\\ -b & a
		\end{pmatrix} \mid a, b \in \real \in \real \mbox{ e não nulos simultaneamente}\right\}.
	\]
...
\questao Seja $G$ um grupo com notação multiplicativa. Considere o subconjunto $Z(G) = \{x \in G \mid xg = gx, \mbox{ para todo } x \in G\}$. Mostre que:
\begin{enumerate}[label=({\alph*})]
