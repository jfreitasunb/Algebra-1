...
\questao{}
	Mostre que a interse\c{c}\~ao de dois suban\'eis de um anel $A$ \'e ainda um subanel de $A$.
...
\questao{}
	Nos \textbf{Exerc{\'\i}cios de \ref{inicio_referencia} a \ref{fim_referencia}} para as fun\c{c}\~oes que forem homomorfismos determine se elas tamb\'em s\~ao isomorfismos.
