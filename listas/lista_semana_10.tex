...
\begin{document}
    ...
    \end{align*}
    para todos $(a, b)$, $(c, d) \in \z\times\z$.
    Mostre que $ f : \z \to \z\times\z$ definada por $f(a, b) = a$ \'e um homomorfismo.
    ...
    \begin{enumerate}[label=({\alph*})]
        ...
        \item Se $J$ {\'e} um ideal de $B$ e $f$ \'e sobrejetora, ent{\~a}o $f^{-1}(J)$ {\'e} um ideal de $A$.
    \end{enumerate}
    ...
    \begin{enumerate}[label=({\alph*})]
        ...
        \item Sejam $J_1$, $J_2 \subset A$ ideiais tais que $J_1 \subset J_2$. Mostre que $J_1 \cup J_2$ é um ideal de $A$.
