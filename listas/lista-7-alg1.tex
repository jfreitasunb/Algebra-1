...
\begin{enumerate}[label=({\alph*})]
	...
	\item $(\q, \star)$, onde $x \star y = x + xy$, para $x$, $y \in \q$;
	...
	\item $(G, \cdot)$, onde $G = \{x \in \q \mid x > 0\}$ e $\cdot$ \'e a multiplica\c{c}\~ao de n\'umeros racionais.
	...
	\item $(G, +)$, onde $G = \{a + b\sqrt{2} \mid a, b \in \q\}$ e $+$ \'e a soma de n\'umeros reais.
	\item $(G, \cdot)$, onde $G = \{a + b\sqrt{2} \in \real^* \mid a, b \in \q\}$ e $\cdot$ \'e a multipli\c{c}\~ao de n\'umeros reais.
	\item $(G, +)$, onde $G = \{a + b\sqrt[3]{2} \mid a, b \in \q\}$ e $+$ \'e a soma de n\'umeros reais.
	\item $(G, \cdot)$, onde $G = \{a + b\sqrt[3]{2} \in \real^* \mid a, b \in \q\}$ e $\cdot$ \'e a multipli\c{c}\~ao de n\'umeros reais..
\end{enumerate}
