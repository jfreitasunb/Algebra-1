...
\begin{center}
 ...
 \vspace{9pt} {\large\bf $5^{\underline{a}}$ Lista de Exerc{\'\i}cios -- An\'eis e Homomorfismos}\\
...
\questao{inicio_referencia}{} Verificar se a fun\c{c}\~ao $f : A \to B$ \'e ou n\~ao um homomorfismo do anel $A$ no anel $B$, nos seguintes casos:
\begin{enumerate}[label=({\alph*})]
...
\questao{fim_referencia} Considere os an{\'e}is $\z$ e $\z\times \z$. Verifique se as seguintes fun\c{c}\~oes s{\~a}o homomorfismos:
\begin{enumerate}[label=({\alph*})]
...
\questao{} Determine o kernel dos homomorfismos dos \textbf{Exerc{\'i}cios de \ref{inicio_referencia} a \ref{fim_referencia}}.

\vesp

\questao{} Nos \textbf{Exerc{\'\i}cios de \ref{inicio_referencia} a \ref{fim_referencia}} para as fun\c{c}\~oes que forem homomorfismos determine se elas tamb\'em s\~ao isomorfismos.
