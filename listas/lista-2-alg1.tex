...
\questao Para $a$, $b \in \real$ defina $aRb$ quando $ab = 0$. Prove ou dê um contra-exemplo a cada uma das seguintes afirmações:
\begin{enumerate}
  \item A relação $R$ satisfaz a propriedade reflexiva.
  \item A relação $R$ satisfaz a propriedade simétrica.
  \item A relação $R$ satisfaz a propriedade transitiva.
\end{enumerate}

\vesp

\questao Para $a$, $b \in \real$ defina $aRb$ quando $ab \ne 0$. Prove ou dê um contra-exemplo a cada uma das seguintes afirmações:
\begin{enumerate}
  \item A relação $R$ satisfaz a propriedade reflexiva.
  \item A relação $R$ satisfaz a propriedade simétrica.
  \item A relação $R$ satisfaz a propriedade transitiva.
...
\questao Para $a$, $b \in \real$ defina $aRb$ quando $\mid a - b \mid < 5$. Prove ou dê um contra-exemplo a cada uma das seguintes afirmações:
\begin{enumerate}
  \item A relação $R$ satisfaz a propriedade reflexiva.
  \item A relação $R$ satisfaz a propriedade simétrica.
  \item A relação $R$ satisfaz a propriedade transitiva.
...
\questao Defina a função $f : \real \to \real$ por $f(x) = x^2 + 1$. Para $a$, $b \in \real$ defina $aRb$ quando $f(a) = f(b)$.
\begin{enumerate}
  \item Prove que $R$ é uma relação de equivalência em $\real$.
...
\questao Para pontos $(a, b)$, $(c, d) \in \real^e$ defina $(a, b) \sym (c, d)$ quando $a^2 + b^2 = c^2 + d^2$.
\begin{enumerate}
  \item Prove que $\sym$ é uma relação de equivalência em $\real^2$.
  \item Liste todos os elementos no conjunto $\{(x, y) \in \real \mid (x, y) \sym (0, 0)\}$.
  \item Liste cinco elementos distintos no conjunto $\{(x, y) \in \real \mid (x, y) \sym (1, 0)\}$.
\end{enumerate}
