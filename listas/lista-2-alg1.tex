...
\questao Dizer se cada um dos seguintes subconjuntos de $\n$ é ou não totalmente ordenado pela relação de divisibilidade:
\begin{enumerate}
  \item $\{24, 2, 6\}$
  \item $\{3,15,5\}$
  \item $\{15,5,30\}$
...
\questao Seja $\cmp$ o conjunto dos números complexos e sejam $x = a + bi$ e $y = c + di$ dois elementos de $\cmp$. Defina $x R y$ se, e somente se, $a \le c$ e $b \le d$. Mostre que $R$ é uma relação de ordem parcial em $\cmp$.

\vesp

\questao Em $\n \times \n$ defina $(a, b) \le (c, d)$ se, e somente se, $a \mid c$ e $b \le d$. Mostre que $\le$ é uma relação de ordem parcial em $\n \times \n$.
