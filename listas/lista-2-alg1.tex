...
\questao Para $a$, $b \in \real$ defina $aRb$ quando $ab = 0$. Prove ou d\^e um contra-exemplo a cada uma das seguintes afirma\c{c}\~oes:
\begin{enumerate}[label={\alph*})]
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade reflexiva.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade sim\'etrica.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade transitiva.
\end{enumerate}

\vesp

\questao Para $a$, $b \in \real$ defina $aRb$ quando $ab \ne 0$. Prove ou d\^e um contra-exemplo a cada uma das seguintes afirma\c{c}\~oes:
\begin{enumerate}[label={\alph*})]
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade reflexiva.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade sim\'etrica.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade transitiva.
...
\questao Para $a$, $b \in \real$ defina $aRb$ quando $\mid a - b \mid < 5$. Prove ou d\^e um contra-exemplo a cada uma das seguintes afirma\c{c}\~oes:
\begin{enumerate}[label={\alph*})]
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade reflexiva.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade sim\'etrica.
  \item A rela\c{c}\~ao $R$ satisfaz a propriedade transitiva.
...
\questao Defina a fun\c{c}\~ao $f : \real \to \real$ por $f(x) = x^2 + 1$. Para $a$, $b \in \real$ defina $aRb$ quando $f(a) = f(b)$.
\begin{enumerate}[label={\alph*})]
  \item Prove que $R$ \'e uma rela\c{c}\~ao de equival\^encia em $\real$.
  \item Liste todos os elementos no conjunto $\{x \in \real \mid xR3\}$.
\end{enumerate}

\vesp

\questao Para pontos $(a, b)$, $(c, d) \in \real^e$ defina $(a, b) \sim (c, d)$ quando $a^2 + b^2 = c^2 + d^2$.
\begin{enumerate}[label={\alph*})]
  \item Prove que $\sim$ \'e uma rela\c{c}\~ao de equival\^encia em $\real^2$.
  \item Liste todos os elementos no conjunto $\{(x, y) \in \real \mid (x, y) \sim (0, 0)\}$.
  \item Liste cinco elementos distintos no conjunto $\{(x, y) \in \real \mid (x, y) \sim (1, 0)\}$.
\end{enumerate}

\vesp

\questao Sejam $E = \{-3, -2, -1, 0, 1, 2, 3\}$ e $R = \{(x, y) \in E \times E \mid x + |x| = y + |y|\}$. Mostrar que $R$ é uma relação de equivalência e descrever $E/R$.
