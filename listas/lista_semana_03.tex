...
\begin{enumerate}[label={\alph*})]
    ...
    \item $(A \cap B) \cup C_E((A \cup C_E(B))) = B$. \textit{(Aqui suponha que $A$, $B$, $C \sub E$.)}
...
\questao{} Seja $A$ e $B$ conjuntos tais que $A$, $B \subseteq E$. É verdade que $C_{E\times E}(A \times B) = C_E(A) \times C_E(B)$? Prove ou apresente um contra-exemplo.
