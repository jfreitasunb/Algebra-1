...
\questao Dados os conjuntos $A = \{0,1,2\}$, $B = \{0,2,3\}$ e $C = \{0,1,2,3,4\}$, classifique as afirma\c{c}\~oes a seguir em verdadeira ou falsa:
\begin{multicols}{2}
...
\item Se $A\cup B = E$, ent\~ao $C_E(A) \sub B$ (Aqui suponha que $A \sub E$ e $B \sub E$).

\item Se $A \cap B = \vaz$, ent\~ao $A \cup C_E(B) = C_E(B)$ (Aqui suponha que $A \sub E$ e $B \sub E$).
