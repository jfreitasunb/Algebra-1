...
\newtheorem{observacoes}{Observa{\c c}{\~o}es}[definicao]
...
\include{prefacio-e-notacoes}
%\include{nocoes-de-logica}
\include{teoria-de-conjuntos}
% \include{numeros-inteiros}
% \include{relacoes-e-funcoes}
% \include{operacoes-em-Zm}
% \include{aneis}
% \include{grupos}
