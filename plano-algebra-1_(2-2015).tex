...
\textit{Teste em sala}: estes testes serão marcados com pelo menos uma semana de antecedência pelo professor e serão feitos nos 40 minutos finais da aula. Os teste serão feitos em grupos  e recolhidos para correção de parte das questões. Uma nota entre 0 e 10 será atribuída ao grupo.

\textit{Provas:} as provas serão realizadas no horário da aula e as datas estão listadas abaixo e podem, a critério do professor, ser mudadas.
