...
Agora,
\begin{align*}
	(x_1 + I) \odot (y_1 + I) &= (x_1y_1) + I\\
	(x_2 + I) \odot (y_2 + I) &= (x_2y_2) + I
\end{align*}
...
\[
	(x_1 + I) \odot (y + I) = (x_2 + I) \odot (y_2 + I).
\]

\begin{teorema}
	Seja $(A, +, \cdot)$ um anel associativo, comutativo e com unidade. Ent{\~a}o, se $I$ {\'e} um ideal de $A$,
	o quociente $\dfrac{A}{I}$ com as opera{\c c}{\~o}es $\oplus$ e $\odot$ {\'e} um anel associativo,
