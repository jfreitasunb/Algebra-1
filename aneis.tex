...
\begin{exemplo}
    \begin{center}
        \huge{Fazer exemplos de subanel usando a proprosição anterior.}
    \end{center}
\end{exemplo}
...
\begin{exemplo}
    \begin{center}
        \huge{Fazer exemplos de homomorfismos.}
    \end{center}
\end{exemplo}
\begin{proposicao}
...
\begin{exemplo}
    \begin{center}
        \huge{Fazer exemplos de núcleo de homomorfismos.}
    \end{center}
\end{exemplo}
...
\begin{exemplo}
    \begin{center}
        \huge{Fazer exemplos para verificar que é ideal.}
    \end{center}
\end{exemplo}
