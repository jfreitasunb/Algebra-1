...
\begin{exemplo}
    ...
    \begin{solucao}
        ...
        \begin{enumerate}
            ...
            \item Primeiro note que $(0, 0) \in B$, logo $B \ne \emptyset$ e assim podemos aplicar a Proposição \ref{proposical_subanel}. Para isso sejam $(a, b)$, $(c, d) \in B$.
                Temos:
                \begin{align*}
                ...
                \[
                    (ac - bd) + (ad + bc)
                \]
                é sempre um número par. Agora se $a$, $b$, $c$ e $d$ são todos ímpares, então $ac$, $bd$, $ad$ e $bc$ também são ímpares e daí
                \[
                    (ac - bd) + (ad + bc)
                \]
