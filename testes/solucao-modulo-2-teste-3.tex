...
\begin{enumerate}
    ...
    \[
        ...
        \end{bmatrix} \in M_2(\real).
    \]
    é o elemento neutro em $M_2(\real)$.
...
Para que $(M_2(\real), + , \cdot)$ seja um an\'el comutativo é preciso que
\[
    A\cdot B = \begin{pmatrix}
        x & y\\z & t 
    \end{pmatrix} \cdot \begin{pmatrix}
...
\begin{align*}
    ...
    \end{bmatrix}
\end{align*}
Portanto $M_2(\real)$ não é um anel comutativo.
...
\begin{align*}
    ...
    \end{bmatrix}
\end{align*}
para toda $A \in M_2(\real)$. Portanto $M_2(\real)$ é um anel com unidade ou anel unitário e a unidade é a matriz
\[
    1_{M_2(\real)} = \begin{bmatrix}
        1 & 0\\
        0 & 1
