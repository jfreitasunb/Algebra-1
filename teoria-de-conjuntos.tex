...
\begin{definicao}
	Diz-se que o \textbf{valor l\'ogico} de uma proposi\c{c}\~ao \'e ``verdade'' (V) se a proposi\c{c}\~ao \'e verdadeira e ou ``falsidade'' (F) se a proposi\c{c}\~ao \'e falsa.
\end{definicao}

\section{Pr{\'\i}ncipio da n\~ao contradi\c{c}\~ao e do 3$^o$ exclu{\'\i}do} % (fold)
\label{sec:pr{\'\i}ncipio_da_n\~ao_contradi\c{c}\~ao_e_do_3}
\begin{enumerate}
