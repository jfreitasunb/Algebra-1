...
\begin{exemplos}
	...
	\begin{enumerate}
		...
		\item $B \subsetneq A$ pois todo elemento de $B$ também está em $A$. Note que existem elementos de $A$ que não estão em $B$, por exemplo $2 \in A$ e $2 \notin B$.
...
Usando a defini\c{c}\~ao de contin\^encia de conjuntos, Definição \ref{definicao_continencia_conjuntos}, podemos redefinir a igualdade de conjuntos, Definição \ref{igualdade_conjuntos}, da seguinte forma: dados dois conjuntos $A$ e $B$
\begin{center}
