...
Seja $A$ um subconjunto n{\~a}o vazio de $\Z$. Dizemos que $A$ {\'e} \textbf{limitado inferiormente} se existe $l \in \Z$ tal que $l \leq x$, para todo $x\in A$.\index{Números inteiros!Conjuntos limitados}
\end{definicao}
