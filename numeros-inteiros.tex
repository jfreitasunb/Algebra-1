...
Precisamos provar que $r < b$. Para isso, suponha ent{\~a}o que $r \geq b$. Logo $r = a-bq \geq b$, ou seja, $a - bq - b\geq 0$. Isto é, $a - b(q+1) \geq 0$ e desse modo, $a - b(q+1) \in M^{+}$.
...
Observa{\c c}{\~a}o:
\begin{enumerate}
\item Se $d=mdc(a,b)$, ent{\~a}o $d=ax_{0}+by_{0}$, onde $x_{0},y_{0}\in\mathbb{Z}$. Os elementos $x_{0}$ e $y_{0}$ satisfazem que tal igualdade n{\~a}o são {\'u}nicos.
