...
\end{proposicao}
\begin{prova}
	Se $H$ {\'e} subgrupo, ent{\~a}o $H$ {\'e} um grupo. Logo \eqref{subgrupo_condicao_1} e \eqref{subgrupo_condicao_2} s{\~a}o satisfeitos.

	Agora provemos que se $H$ satisfaz \eqref{subgrupo_condicao_1} e \eqref{subgrupo_condicao_2}, ent{\~a}o $H$ {\'e} grupo.

	Como $G$ {\'e} grupo, ent{\~a}o $*$ {\'e} associativa, logo $*$ {\'e} associativa em $H$.

	De \eqref{subgrupo_condicao_1}, para todo $x \in H$, $x^{-1}\in H$. Mas de \eqref{subgrupo_condicao_2}, para todos $x$, $y \in H,$ $x*y \in H$. Logo, se $x\in H$, ent{\~a}o $e = x*x^{-1} \in H$.

	Novamente por \eqref{subgrupo_condicao_1}, todo elemento de $H$ possui inverso em $H$.
...
\begin{exemplos}
	\begin{enumerate}[label={\arabic*})]
		...
		\item $G = U\left(\z_8) = \{\overline{1}, \overline{3}, \overline{5}, \overline{7}\}$. Então $(G,\odot)$ {\'e} um grupo com $|G| = 4$. Além disso,
		\begin{align*}
