...
Se $A = \{1\}$, então só existe uma função $f : A \to A$ que é bijetora e essa função é a identidade. Nesse caso $\mathcal{S} = S_1 = \{Id\}$. Assim $(S_1, \circ)$ é um grupo, e nesse caso comutativo.
...
Assim $\mathcal{S} = S_2 = \{Id, f\}$. Assim $(S_2, \circ)$ é um grupo. Além disso,
\begin{table}[!htb]
\centering
	\begin{tabular}{|c|c|c|} 
	    \hline
