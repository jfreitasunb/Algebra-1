...
Sejam $(G, \cdot)$ um grupo, denotado multiplicamente para fins de simplifica\c{c}\~ao, e $A$ e $B$ subconjuntos de $G$. Vamos indicar por
\[
    AB
\]
...
\begin{exemplos}
    \begin{enumerate}[label={\arabic*})]
        \item Seja $G = \{1, -1, i, -i\}$ um grupo e $N = \{1, -1\}$. Como $G$ \'e um grupo abeliano ent\~ao $N$ \'e um subgrupo normal de $G$. Assim podemos definir o grupo quociente $G/N$. As classes laterais de $N$ s\~ao
        \begin{align*}
        	1N &= N\\
        ...
        \[
        	G/N = \{N, iN\}
        \]
        e a opera\c{c}\~ao em $G$ \'e dada por
        \begin{center}
        	\begin{table}[htp]
        		\centering
        		\caption{$G/N$}
        ...
        \item Seja $G = S_3$. J\'a vimos que se tomamos
                ...
                \[
                    S_3 = \{Id, f, f^2, g, gf, gf^2\}.
                \]
                Considere o subgrupo $H = [\ f\ ] = \{Id, f, f^2\}$. Como $H$ possui somente duas classes laterais, que s\~ao
                \begin{align*}
                	IdH &= H\\
                	gH &= \{g, gf, gf^2\}
                \end{align*}
                ent\~ao $H$ \'e um subgrupo normal de $S_3$. Assim podemos definir o grupo quociente $S_3/H$, onde
                \[
                	S_3/H = \{H, gH\}.
                \]
                Temos
